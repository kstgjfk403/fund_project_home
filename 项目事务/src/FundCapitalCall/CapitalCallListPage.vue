          ...
          <el-form :model="capitalCallForm" ref="capitalCallForm">
            <div class="select-fixed">
              ...
              <el-form-item label="Email Send:">
                <el-select v-model="capitalCallForm.emailsend" placeholder="请选择">
              ...
              <el-form-item label="emailreviewed:">
                <el-select v-model="capitalCallForm.emailreviewed" placeholder="请选择">
                  <el-option v-for="item in options" :key="item.value"
                  :label="item.label" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
              ...
              <el-form-item label="ERISA:">
                <el-select v-model="capitalCallForm.erisa" placeholder="请选择">
                  <el-option v-for="item in options" :key="item.value"
                  :label="item.label" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="moneyreceived:">
                <el-select v-model="capitalCallForm.moneyreceived" placeholder="请选择">
                  <el-option v-for="item in options" :key="item.value"
                  :label="item.label" :value="item.value"></el-option>
                </el-select>
              </el-form-item>
