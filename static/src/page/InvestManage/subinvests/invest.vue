...
<div class="invest loan" ref="Invest">
    <div class="loan-table-container">
        ...
        <el-table :data="investData" border>
            ...
            <el-table-column prop="termsigndate" label="TermSign Date" width="150"></el-table-column>
    ...
    <subCapTable :dataObj='dataObj' :investForm='investForm' :buttonShow='buttonShow' :capTableData='captelDetailData' v-show="subCapTableShow"></subCapTable>
