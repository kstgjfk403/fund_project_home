...
<div class="exit loan">
    <div class="loan-table-container">
        ...
        <el-table ref="singleTable" :data="exitData" border style="width:100%;">
            ...
            <el-table-column prop="costrelization" label="costRelization" width="130"></el-table-column>
            <el-table-column prop="round" label="round"></el-table-column>
            <el-table-column prop="shareexit" label="shares"></el-table-column>
            ...
            <el-table-column prop="shareremain" label="shareremain"></el-table-column>
