        ...
        <div class="loan-table-container">
            ...
            <el-table :data="item.baseName" style="width: 100%" v-for="(item,index) in firstContentList" :key="index+1">
                <el-table-column label="股东信息" width="150">
                    <el-table-column prop="securitytypeidstr" label="股东类型" width="130"></el-table-column>
                    <el-table-column prop="sharetype" label="ShareType" width="130"></el-table-column>
                </el-table-column>
                <el-table-column :label="item.baseId">
                    <el-table-column prop="cost" label="认缴注册资本" width="130"></el-table-column>
                    <el-table-column prop="cost" label="认缴投资额" width="130"></el-table-column>
                    <el-table-column prop="proper" label="股比" width="130"></el-table-column>
                    <el-table-column prop="cost" label="ESOP" width="130"></el-table-column>
                </el-table-column>
            </el-table>
