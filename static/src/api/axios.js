...
export default {
    ...
    reqfundirrstatistics(id){
      return axios.get('/api/admin/fundcapitalcall/irrstastic/'+id);
    },
    //查询fundinvestmentoverview
    reqfundinvestmentoverview(id){
      return axios.get('/api/admin/fundcapitalcall/investmentoverview/'+id);
    },
